...
export default function PropertyForm({
  ...
  return (
    <div
      className="fixed inset-0 z-[120] bg-slate-950/45 backdrop-blur-[1px]"
      onClick={onClose}
    >
            ...
            <div className="space-y-5">
              ...
              >
                <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                  <Field label="Código" value={form.codigo} onChange={(v) => setField("codigo", v)} />
                  <Field
                  ...
                  />
                  <SelectField
                    label="Estado tablero"
                    value={form.estado_tablero}
                    onChange={(v) => setField("estado_tablero", v)}
                    options={["Asignada", "Visita coordinada", "Visitada", "Finalizada"]}
                  />
                </div>
              </Section>
              ...
              <Section title="Textos y observaciones" description="Contenido interno y público.">
                <div className="grid gap-4">
                  ...
                  />
                  {form.estado_tablero === "Finalizada" && (
                    <TextAreaField
                      label="Comentario cierre"
                      value={form.comentario_cierre}
                      onChange={(v) => setField("comentario_cierre", v)}
                    />
                  )}
                </div>
              </Section>
