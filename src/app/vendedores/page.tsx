              ...
              <form onSubmit={handleSubmit} className="px-6 py-6">
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-white p-3">
                    ...
                    <div className="mt-3 flex items-center gap-3 rounded-xl bg-slate-50 px-3 py-2">
                      ...
                      <span className="text-sm text-slate-600">
                        Color seleccionado: <span className="font-medium text-slate-900">{form.color_calendario}</span>
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 flex justify-end gap-3 border-t border-slate-100 pt-5">
                  ...
                  <button
                    type="submit"
                    disabled={saving}
                    className="inline-flex items-center justify-center rounded-2xl bg-gradient-to-r from-blue-600 to-violet-600 px-5 py-3 text-sm font-semibold text-white shadow-[0_16px_35px_rgba(59,130,246,0.28)] transition hover:scale-[1.01] disabled:opacity-60"
                  >
